...
public class DifficultQuestionService {
    ...
    public List<DifficultQuestionDto> getDifficultQuestions(int dashboardId) {
        ...
        dashboard.getDifficultQuestions().stream().forEach(difficultQuestion1 -> {
            if(difficultQuestion1.isRemoved() == false && difficultQuestion1.getRemovedDate() == null) {
                difficultQuestionsDtos.add(new DifficultQuestionDto(difficultQuestion1));
            }

        });
        return difficultQuestionsDtos;
    }
