...
public enum ErrorMessage {
    ...
    NOT_SAME_DIFFICULTY("Difficult question does not match the selected difficulty"),
    SAME_DIFFICULTY_QUESTION_ALREADY_EXISTS("Difficult question already exists"),
    SAME_DIFFICULTY_QUESTION_NOT_FOUND("Same difficult question not found"),
    SAME_DIFFICULTY_QUESTION_REMOVED("Difficult question is already removed"),
    CANNOT_ADD_DIFFICULT_QUESTION("Difficult question cannot be added"),
    ...
    CANNOT_ADD_WEEKLY_SCORE("Impossible to add weekly score to same percentage, correct percentage does not match"),
    WEEKLY_SCORE_ALREADY_ADDED("Weekly score already added to same percentage"),
    CANNOT_ADD_PARENT_WEEKLY_SCORE("Cannot add weekly score to its same percentage"),
    ...
    FAILED_ANSWER_ALREADY_EXISTS("Failed answer already exists"),
    CANNOT_CREATE_FAILED_ANSWER("Cannot create failed answer"),
    CANNOT_REMOVE_FAILED_ANSWER("Cannot remove failed answer"),

    CANNOT_ADD_FAILED_ANSWER("Failed answer key does not match same question key"),
    SAME_QUESTION_NOT_FOUND("Same question not found");
