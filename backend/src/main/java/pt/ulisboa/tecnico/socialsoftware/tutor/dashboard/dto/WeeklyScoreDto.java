...
public class WeeklyScoreDto implements Serializable, Comparable<WeeklyScoreDto> {
  ...
  @Override
  public int compareTo(WeeklyScoreDto weeklyScoreDto) {
    // multiply by -1 to invert the comparison's result
    return (-1)*(DateHandler.toLocalDateTime(this.getWeek()).compareTo(DateHandler.toLocalDateTime(weeklyScoreDto.getWeek())));
  }
