...
export default class RemoteServices {
  ...
  static async getUserFailedAnswers(dashboardId: number): Promise<FailedAnswer[]> {
    return httpClient
      .get(
  ...
  static async getUserWeeklyScores(dashboardId: number): Promise<WeeklyScore[]> {
    return httpClient
      .get(
  ...
  static async removeDifficultQuestions(difficultQuestionId: number){
    return httpClient.delete(
        `/students/dashboards/difficultquestions/${difficultQuestionId}/remove`
      )
      .catch(async (error) => {
        throw Error(await this.errorMessage(error));
      });
  ...
  static async removeUserFailedAnswer(failedAnswerId: number){
    return httpClient
      .delete(
        `/students/dashboards/failedAnswers/${failedAnswerId}/remove`
      )
      .catch(async (error) => {
        throw Error(await this.errorMessage(error));
      });
  ...
  static async updateUserFailedAnswers(dashboardId: number){
    return httpClient
      .put(
        `/students/dashboards/${dashboardId}/failedanswers/update`
      )
      .catch(async (error) => {
        throw Error(await this.errorMessage(error));
      });
  ...
  static async removeUserWeeklyScores(weeklyScoreId: number){
    return httpClient.delete(
        `/weeklyScore/${weeklyScoreId}`
      )
      .catch(async (error) => {
        throw Error(await this.errorMessage(error));
      });
  ...
  static async updateDifficultQuestions(dashboardId: number){
    ...
    static async updateUserWeeklyScores(dashboardId: number): Promise<WeeklyScore[]>{
      return httpClient
        .put(
            `/students/dashboards/${dashboardId}/updateWeeklyScores`
        ).then((response) => {
        return response.data.map((weeklyScore: any) => {
          return new WeeklyScore(weeklyScore);
        });
