...
import static pt.ulisboa.tecnico.socialsoftware.tutor.exceptions.ErrorMessage.UPDATE_WEEKLY_SCORE_NOT_POSSIBLE;
...
public class WeeklyScore implements DomainEntity {
    ...
    public void setPercentageCorrect(int percentageCorrect) {
        if (percentageCorrect < 0 || percentageCorrect > 100){
            throw new TutorException(UPDATE_WEEKLY_SCORE_NOT_POSSIBLE);
        }
