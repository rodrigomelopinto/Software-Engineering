...
class RemoveDifficultQuestionTest extends SpockTest {
    ...
    @Unroll
    def "the difficult question cannot be deleted days after #daysSince or not removed #removed"() {
        ...
        true    | 5         || CANNOT_REMOVE_DIFFICULT_QUESTION
        true    | 6         || CANNOT_REMOVE_DIFFICULT_QUESTION
    }
